    ...
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center space-x-2 space-x-reverse mb-4">
            ...
            <span class="text-2xl font-bold">أوان كورسات</span>
          </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="/courses" class="text-gray-300 hover:text-white transition-colors">الكورسات</a></li>
            <li><a href="/instructors" class="text-gray-300 hover:text-white transition-colors">المدربين</a></li>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="/help" class="text-gray-300 hover:text-white transition-colors">مركز المساعدة</a></li>
            <li><a href="/faq" class="text-gray-300 hover:text-white transition-colors">الأسئلة الشائعة</a></li>
            <li><a href="/terms" class="text-gray-300 hover:text-white transition-colors">الشروط والأحكام</a></li>
      ...
      <div class="border-t border-gray-700 mt-8 pt-8 text-center">
        <p class="text-gray-400">
          © {{ new Date().getFullYear() }} أوان كورسات. جميع الحقوق محفوظة.
        </p>
      </div>
    </div>
  </footer>
